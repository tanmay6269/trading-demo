...
import api from '../../api';
import OrdersChart from '../trading/OrdersChart';
...
const Orders = () => {
        ...
        return (
            <div className="soft-card fade-in" style={{ padding: '40px 20px', textAlign: 'center' }}>
                <div style={{
                    ...
                    borderRadius: '20px', background: 'var(--accent-primary-soft)',
    ...
    return (
        <div>
            {/* shadcn Trading Activity Bar Chart */}
                            ...
                            {orders.map((order) => {
                                ...
                                return (
                                    <tr key={order.id}>
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            <span className="soft-badge neutral">{order.status}</span>
                                        </td>
