...
OFFICIAL_LOT_SIZES = {
    'NSE': {
        ...
        'TATAMOTORS': 700, 'TATASTEEL': 5500, 'SUNPHARMA': 350, 'AXISBANK': 625,
        'MARUTI': 50, 'BAJFINANCE': 125, 'KOTAKBANK': 400, 'LT': 150, 'ZOMATO': 2000,
        'ADANIENT': 300, 'ADANIPORTS': 400, 'ASIANPAINT': 200, 'BAJAJ-AUTO': 75,
        'BAJAJFINSV': 500, 'BEL': 2850, 'BHEL': 2625, 'COALINDIA': 2100, 'DLF': 825,
        'EICHERMOT': 175, 'GRASIM': 250, 'HAL': 150, 'HAVELLS': 500, 'HDFCLIFE': 1100,
        'HEROMOTOCO': 150, 'HINDALCO': 1400, 'HINDUNILVR': 300, 'INDUSINDBK': 500,
        'IOC': 4875, 'JSWSTEEL': 675, 'LTIM': 150, 'M&M': 350, 'NESTLEIND': 250,
        'NTPC': 1500, 'ONGC': 3850, 'PFC': 1950, 'PIDILITIND': 250, 'PNB': 8000,
        'POWERGRID': 2700, 'RECLTD': 2000, 'SBILIFE': 750, 'SIEMENS': 125,
        'TATACONSUM': 900, 'TATAPOWER': 2025, 'TECHM': 600, 'TRENT': 100,
        'ULTRACEMCO': 100, 'VEDL': 2300
    },
    'BSE': {
        'SENSEX': 10, 'BSE SENSEX': 10, '^BSESN': 10,
        'BANKEX': 15, 'SENSEX 50': 25,
        'RELIANCE': 250, 'TCS': 175, 'HDFCBANK': 550, 'INFY': 400, 'ICICIBANK': 700,
        'SBIN': 750, 'TATAMOTORS': 700
    }
}
